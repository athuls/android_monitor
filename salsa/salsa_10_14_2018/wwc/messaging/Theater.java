...
public class Theater implements TheaterService {
	  ...
	  // System.err.println("[Custom debug error] 2 Property network interface is " + propertyNetIf);
	    ...
	    // System.err.println("[Custom debug error] 2 netIfSpecified " + Theater.netIfSpecified);
...
//System.out.println("accept .........");
        ...
        public synchronized String getHost() {
				...
				// System.err.println("[Custom debug error] 1 host name is " + hostName);
                        }
                        else {     	
                                try {
                                        hostName = InetAddress.getLocalHost().getHostAddress();
					// System.err.println("[Custom debug error] 2 host name is " + hostName);
