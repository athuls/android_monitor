...
public class Exp_Starter extends UniversalActor  {
	public static void main(String args[]) {
		...
		Exp_Starter instance = (Exp_Starter)new Exp_Starter(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Exp_Starter(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Exp_Starter.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Exp_Starter(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Exp_Starter.getReferenceByLocation(new UAL(ual)); }
	public Exp_Starter(boolean o, UAN __uan)	{ super(false,__uan); }
	public Exp_Starter(boolean o, UAL __ual)	{ super(false,__ual); }
	public Exp_Starter(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Exp_Starter(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Exp_Starter(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Exp_Starter()		{  }
	public Exp_Starter(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.facedetection.Exp_Starter", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Exp_Starter self;
		public void updateSelf(ActorReference actorReference) {
			((Exp_Starter)actorReference).setUAL(getUAL());
			((Exp_Starter)actorReference).setUAN(getUAN());
			self = new Exp_Starter(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.facedetection.Exp_Starter$State" );
		...
		Phone_App_Manager phone_app_manager = null;
		public void act(String args[]) {
			...
			if (argc<2) {{
				{
					...
					{
						Object _arguments[] = { " Exp_Starter:: ERROR!!! You need to specify the [name_server] and [phone_theater] as the first two arguments" };
			...
			phone_theater = args[1];
			{
				...
				{
					Object _arguments[] = { " Exp_Starter :: Creating Phone_App_Manager on "+phone_theater+" using nameserver: "+name_server };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			phone_app_manager = ((Phone_App_Manager)new Phone_App_Manager(new UAN(name_server+"phone_app_manager"), new UAL(phone_theater+"phone_app_manager"),this).construct());
			{
				Token token_2_0 = new Token();
				// standardOutput<-println(" Exp_Starter:: Starting Phone_App_Manager on "+phone_theater+" using nameserver: "+name_server)
				{
					Object _arguments[] = { " Exp_Starter:: Starting Phone_App_Manager on "+phone_theater+" using nameserver: "+name_server };
					Message message = new Message( self, standardOutput, "println", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// phone_app_manager<-start_app(((Exp_Starter)self), args)
				{
					Object _arguments[] = { ((Exp_Starter)self), args };
					Message message = new Message( self, phone_app_manager, "start_app", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
		}
		public void wrap_up(long total_runtime, String status) {
			{
				Token token_2_0 = new Token();
				// standardOutput<-println(" Exp_Starter:: Total Phone_app runtime is: "+total_runtime)
				{
					Object _arguments[] = { " Exp_Starter:: Total Phone_app runtime is: "+total_runtime };
					Message message = new Message( self, standardOutput, "println", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// standardOutput<-println(" Exp_Starter:: Phone_App_Manager has finished with the resulf of: "+status)
				{
					Object _arguments[] = { " Exp_Starter:: Phone_App_Manager has finished with the resulf of: "+status };
