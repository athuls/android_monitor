...
public class ServiceFactory {
	...
	//private static String			outputClass	= "androidsalsa.resources.StandardOutput";
        private static String			inputClass	= "wwc.resources.StandardInput";
        //private static String			inputClass	= "androidsalsa.resources.StandardInput";
	private static String			errorClass	= "wwc.resources.StandardError";
	//private static String			errorClass	= "androidsalsa.resources.StandardError";
...
//System.out.println( "### getOutput(), className = " + className );			
