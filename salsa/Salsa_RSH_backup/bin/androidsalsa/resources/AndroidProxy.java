...
public class AndroidProxy {
	...
	private static androidsalsa.resources.StandardOutput.State stdoutput_1, stdoutput_2;
	...
	public static void setTextViewContext( Activity context, TextView textView ) {
		debugPrint("Setting text view context");
	...
	public static boolean postText( final String str ) {
		...
		context.runOnUiThread( new Runnable() {
			public void run() {
					debugPrint("Run of posting text");
  ...
  public static void startBatteryStatusBroadcast(androidsalsa.resources.StandardOutput.State s){
  ...
  public static void startEnergyProfilerUpdateBroadcast(androidsalsa.resources.StandardOutput.State s){
