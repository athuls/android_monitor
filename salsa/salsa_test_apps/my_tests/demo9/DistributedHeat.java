...
public class DistributedHeat extends UniversalActor  {
	...
	public DistributedHeat(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo9.DistributedHeat", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "demo9.DistributedHeat$State" );
...
continue;					}
		...
		public double[][] doWork(double[][] data, int iterations, int noActors, String nameServer, String theatersFile) {
			{
				// standardOutput<-println("DoWork: Part1")
				{
					Object _arguments[] = { "DoWork: Part1" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			...
			{
				// standardOutput<-println("DoWork: Part2")
				{
					Object _arguments[] = { "DoWork: Part2" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			...
			{
				// standardOutput<-println("DoWork: Part3")
				{
					Object _arguments[] = { "DoWork: Part3" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			...
			{
				// standardOutput<-println("DoWork: Part4")
				{
					Object _arguments[] = { "DoWork: Part4" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			...
			{
				// standardOutput<-println("DoWork: Part5")
				{
					Object _arguments[] = { "DoWork: Part5" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
		...
		public void act(String args[]) {
			...
			y += 2;
			{
				// standardOutput<-println("DistributedHeat: ACT()")
				{
					Object _arguments[] = { "DistributedHeat: ACT()" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
