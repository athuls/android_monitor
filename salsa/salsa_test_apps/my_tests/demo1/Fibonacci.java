...
public class Fibonacci extends UniversalActor  {
	...
	public Fibonacci(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo1.Fibonacci", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "demo1.Fibonacci$State" );
		...
		public void endTimer() {
			...
			{
				// standardOutput<-println("Running time for Fibonacci problem is "+runningTime+" ms.")
				{
					Object _arguments[] = { "Running time for Fibonacci problem is "+runningTime+" ms." };
