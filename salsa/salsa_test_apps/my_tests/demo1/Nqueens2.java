...
public class Nqueens2 extends UniversalActor  {
	public static void main(String args[]) {
		...
		Nqueens2 instance = (Nqueens2)new Nqueens2(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Nqueens2(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Nqueens2.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Nqueens2(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Nqueens2.getReferenceByLocation(new UAL(ual)); }
	public Nqueens2(boolean o, UAN __uan)	{ super(false,__uan); }
	public Nqueens2(boolean o, UAL __ual)	{ super(false,__ual); }
	public Nqueens2(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Nqueens2(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Nqueens2(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Nqueens2()		{  }
	public Nqueens2(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo1.Nqueens2", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Nqueens2 self;
		public void updateSelf(ActorReference actorReference) {
			((Nqueens2)actorReference).setUAL(getUAL());
			((Nqueens2)actorReference).setUAN(getUAN());
			self = new Nqueens2(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "demo1.Nqueens2$State" );
		...
		public void act(String args[]) {
			try {
				Nqueens2[] actors = new Nqueens2[Integer.parseInt(args[1])];
				for (int i = 0; i<actors.length; i++){
					actors[i] = ((Nqueens2)new Nqueens2(this).construct());
				}
				...
				if (SIZE<6) {{
					{
						...
						// ((Nqueens2)self)<-compute(0, 0, 0, 0, new Integer(SIZE), new Integer(MASK))
						{
							Object _arguments[] = { new Integer(0), new Integer(0), new Integer(0), new Integer(0), new Integer(SIZE), new Integer(MASK) };
							Message message = new Message( self, ((Nqueens2)self), "compute", _arguments, null, token_4_0 );
							__messages.add( message );
						}
						// ((Nqueens2)self)<-getCount()
						{
							Object _arguments[] = {  };
							Message message = new Message( self, ((Nqueens2)self), "getCount", _arguments, token_4_0, token_4_1 );
							__messages.add( message );
						}
					...
					int bitmap = (MASK&~(left|down|right));
					{
						...
						// ((Nqueens2)self)<-add(token)
						{
							Object _arguments[] = { token_4_1 };
							Message message = new Message( self, ((Nqueens2)self), "add", _arguments, token_4_1, token_4_2 );
							__messages.add( message );
						}
						// ((Nqueens2)self)<-getCount()
						{
							Object _arguments[] = {  };
							Message message = new Message( self, ((Nqueens2)self), "getCount", _arguments, token_4_2, token_4_3 );
							__messages.add( message );
						}
						// standardOutput<-println(token)
						{
...
;				}
				...
				System.err.println("USAGE:java examples.nqueens.Nqueens2 <N> <# of actors>");
			}
