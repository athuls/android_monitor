...
public class Trap extends UniversalActor  {
	...
	public Trap(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo8.Trap", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		int n = 1024;
		long initialTime;
		String nameServer = "192.168.1.138";
		String theatersFile = "./demo8/theatersFile.txt";
		public void act(String args[]) {
			double test = -1.0;
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "endTimer", _arguments, token_2_1, token_2_2 );
					__messages.add( message );
				}
				// displayResults(test)
				{
					Object _arguments[] = { test };
					Message message = new Message( self, self, "displayResults", _arguments, token_2_2, currentMessage.getContinuationToken() );
					__messages.add( message );
				}
