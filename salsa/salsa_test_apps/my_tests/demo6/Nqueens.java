...
public class Nqueens extends UniversalActor  {
	...
	public Nqueens(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo6.Nqueens", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "demo6.Nqueens$State" );
		...
		public void endTimer() {
			...
			{
				// standardOutput<-println("Running time for NQueens problem is "+runningTime+" ms.")
				{
					Object _arguments[] = { "Running time for NQueens problem is "+runningTime+" ms." };
				...
				if (SIZE<6) {{
					{
						...
						{
							Object _arguments[] = {  };
							Message message = new Message( self, self, "endTimer", _arguments, token_4_2, null );
							__messages.add( message );
						}
					}
				}
					...
					int bitmap = (MASK&~(left|down|right));
					{
						...
						{
							Object _arguments[] = {  };
							Message message = new Message( self, self, "endTimer", _arguments, token_4_4, null );
							__messages.add( message );
						}
					}
				}
