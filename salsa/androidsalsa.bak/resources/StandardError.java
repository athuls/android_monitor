...
public class StandardError extends UniversalActor  implements ErrorService {
    public static void main(String args[]) {
        ...
        StandardError instance = (StandardError)new StandardError(uan, ual,null).construct();
    ...
    public StandardError(boolean o, UAN __uan)	{ super(false,__uan); }
    public StandardError(boolean o, UAL __ual)	{ super(false,__ual); }
    public StandardError(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
    public StandardError(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
    public StandardError(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
    public StandardError()		{  }
    public StandardError(UAN __uan, UAL __ual, Object obj) {
        ...
        if (obj instanceof UniversalActor.State || obj==null) {
            ...
            if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
                ...
                createRemotely(__uan, __ual, "androidsalsa.resources.StandardError", sourceRef);
            }
    ...
    public class State extends UniversalActor .State implements ErrorService.State {
        public StandardError self;
        public void updateSelf(ActorReference actorReference) {
            ((StandardError)actorReference).setUAL(getUAL());
            ((StandardError)actorReference).setUAN(getUAN());
            self = new StandardError(false,getUAL());
            self.setUAN(getUAN());
            self.setUAL(getUAL());
            self.activateGC();
        }
        ...
        public State(UAN __uan, UAL __ual) {
            super(__uan, __ual);
            addClassName( "androidsalsa.resources.StandardError$State" );
