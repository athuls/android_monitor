package examples.offloadDebugApp;
...
public class NumbersFaceDetect extends UniversalActor  {
	public static void main(String args[]) {
		...
		NumbersFaceDetect instance = (NumbersFaceDetect)new NumbersFaceDetect(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new NumbersFaceDetect(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return NumbersFaceDetect.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new NumbersFaceDetect(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return NumbersFaceDetect.getReferenceByLocation(new UAL(ual)); }
	public NumbersFaceDetect(boolean o, UAN __uan)	{ super(false,__uan); }
	public NumbersFaceDetect(boolean o, UAL __ual)	{ super(false,__ual); }
	public NumbersFaceDetect(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public NumbersFaceDetect(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public NumbersFaceDetect(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public NumbersFaceDetect()		{  }
	public NumbersFaceDetect(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.offloadDebugApp.NumbersFaceDetect", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public NumbersFaceDetect self;
		public void updateSelf(ActorReference actorReference) {
			((NumbersFaceDetect)actorReference).setUAL(getUAL());
			((NumbersFaceDetect)actorReference).setUAN(getUAN());
			self = new NumbersFaceDetect(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.offloadDebugApp.NumbersFaceDetect$State" );
		...
		public void createCompute(String mode) {
			int duration = 0;
			duration = 4000;
		...
		public void act(String args[]) {
...
}			NumbersFaceDetect[] actorList = new NumbersFaceDetect[numActors];
			{
				...
				for (int i = 0; i<numActors; i++){
					...
					actorList[i] = ((NumbersFaceDetect)new NumbersFaceDetect(new UAN("uan://osl-server1.cs.illinois.edu:3030"+"/numsFdchild"+actorId), new UAL("rmsp://"+args[1]+":4040/numsFdChildLoc"+actorId),this).construct());
					{
						// actorList[i]<-createCompute(mode)
						{
							Object _arguments[] = { mode };
				...
				{
					Object _arguments[] = { "Config mode is "+mode+" and #actors is "+numActors };
