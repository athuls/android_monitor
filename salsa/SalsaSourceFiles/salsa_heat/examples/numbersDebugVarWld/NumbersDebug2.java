package examples.numbersDebugVarWld;
...
public class NumbersDebug2 extends UniversalActor  {
	public static void main(String args[]) {
		...
		NumbersDebug2 instance = (NumbersDebug2)new NumbersDebug2(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new NumbersDebug2(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return NumbersDebug2.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new NumbersDebug2(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return NumbersDebug2.getReferenceByLocation(new UAL(ual)); }
	public NumbersDebug2(boolean o, UAN __uan)	{ super(false,__uan); }
	public NumbersDebug2(boolean o, UAL __ual)	{ super(false,__ual); }
	public NumbersDebug2(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public NumbersDebug2(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public NumbersDebug2(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public NumbersDebug2()		{  }
	public NumbersDebug2(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbersDebugVarWld.NumbersDebug2", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public NumbersDebug2 self;
		public void updateSelf(ActorReference actorReference) {
			((NumbersDebug2)actorReference).setUAL(getUAL());
			((NumbersDebug2)actorReference).setUAN(getUAN());
			self = new NumbersDebug2(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbersDebugVarWld.NumbersDebug2$State" );
		...
		public void createCompute(int duration) {
...
do {
 ...
 while (finalTime>currentTime);
		...
		public void act(String args[]) {
			...
			NumbersDebug2[] actorList = new NumbersDebug2[numActors];
			{
				...
				for (int i = 0; i<numActors; i++){
					...
					actorList[i] = ((NumbersDebug2)new NumbersDebug2(new UAN("uan://osl-server1.cs.illinois.edu:3030"+"/numsFdchild"+actorId), new UAL("rmsp://"+args[2]+":4040/numsFdChildLoc"+actorId),this).construct());
					{
						// actorList[i]<-createCompute(duration)
						{
							Object _arguments[] = { duration };
							Message message = new Message( self, actorList[i], "createCompute", _arguments, null, token_2_0 );
							__messages.add( message );
						}
					}
				}
				addJoinToken(token_2_0);
				// standardOutput<-println("Config mode is low and #actors is "+numActors)
				{
					Object _arguments[] = { "Config mode is low and #actors is "+numActors };
