...
public class NumbersDebug1 extends UniversalActor  {
	public static void main(String args[]) {
		...
		NumbersDebug1 instance = (NumbersDebug1)new NumbersDebug1(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new NumbersDebug1(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return NumbersDebug1.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new NumbersDebug1(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return NumbersDebug1.getReferenceByLocation(new UAL(ual)); }
	public NumbersDebug1(boolean o, UAN __uan)	{ super(false,__uan); }
	public NumbersDebug1(boolean o, UAL __ual)	{ super(false,__ual); }
	public NumbersDebug1(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public NumbersDebug1(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public NumbersDebug1(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public NumbersDebug1()		{  }
	public NumbersDebug1(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbersDebugVarWld.NumbersDebug1", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public NumbersDebug1 self;
		public void updateSelf(ActorReference actorReference) {
			((NumbersDebug1)actorReference).setUAL(getUAL());
			((NumbersDebug1)actorReference).setUAN(getUAN());
			self = new NumbersDebug1(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbersDebugVarWld.NumbersDebug1$State" );
		...
		public void act(String args[]) {
			...
			NumbersDebug1[] actorList = new NumbersDebug1[numActors];
			{
				...
				for (int i = 0; i<numActors; i++){
					...
					actorList[i] = ((NumbersDebug1)new NumbersDebug1(new UAN("uan://osl-server1.cs.illinois.edu:3030"+"/numsFdchild"+actorId), new UAL("rmsp://"+args[2]+":4040/numsFdChildLoc"+actorId),this).construct());
					{
				...
				{
					Object _arguments[] = { "Config mode is high and #actors is "+numActors };
