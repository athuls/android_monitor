...
public class Face_Detector extends UniversalActor  {
	public static void main(String args[]) {
		...
		Face_Detector instance = (Face_Detector)new Face_Detector(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Face_Detector(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Face_Detector.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Face_Detector(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Face_Detector.getReferenceByLocation(new UAL(ual)); }
	public Face_Detector(boolean o, UAN __uan)	{ super(false,__uan); }
	public Face_Detector(boolean o, UAL __ual)	{ super(false,__ual); }
	public Face_Detector(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Face_Detector(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Face_Detector(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Face_Detector()		{  }
	public Face_Detector(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.facedetection.Face_Detector", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Face_Detector self;
		public void updateSelf(ActorReference actorReference) {
			((Face_Detector)actorReference).setUAL(getUAL());
			((Face_Detector)actorReference).setUAN(getUAN());
			self = new Face_Detector(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.facedetection.Face_Detector$State" );
		...
		public void start_up(Phone_App_Manager pam) {
			phone_app_manager = pam;
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, phone_app_manager, "get_image", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// ((Face_Detector)self)<-process_image(token)
				{
					Object _arguments[] = { token_2_0 };
					Message message = new Message( self, ((Face_Detector)self), "process_image", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
		}
		public void process_image(String image) {
			if (image==null) {{
				...
				this.report(this.getUAN().toString()+" --> finished processing <"+image+"> in time: "+total_run_time+" with number of faces detected being: "+no_detected_faces);
				{
					Token token_3_0 = new Token();
					// phone_app_manager<-get_image()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, phone_app_manager, "get_image", _arguments, null, token_3_0 );
						__messages.add( message );
					}
					// ((Face_Detector)self)<-process_image(token)
					{
						Object _arguments[] = { token_3_0 };
						Message message = new Message( self, ((Face_Detector)self), "process_image", _arguments, token_3_0, null );
						__messages.add( message );
					}
				}
			}
