...
import org.tensorflow.lite.examples.classification.CameraConnectionFragment.CompareSizesByArea.Companion as CompareSizesByArea
    ...
    companion object {
        ...
        fun chooseOptimalSize(choices: Array<Size>, width: Int, height: Int): Size? {
            ...
            return if (bigEnough.size > 0) {
               ...
               // val great = CompareSizesByArea()

                val greaterThan = object : Comparator<Size?>
                {
                ...
                val chosenSize = bigEnough.minWith(greaterThan)
...
// device this code runs.
    ...
    internal class CompareSizesByArea {
        companion object: Comparator<Size>
        {
            override fun compare(lhs: Size, rhs: Size): Int { // We cast here to ensure the multiplications won't overflow
                return java.lang.Long.signum(
                        lhs.width.toLong() * lhs.height - rhs.width.toLong() * rhs.height)
