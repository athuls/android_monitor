...
public class Idle extends UniversalActor  {
	public static void main(String args[]) {
		...
		Idle instance = (Idle)new Idle(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Idle(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Idle.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Idle(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Idle.getReferenceByLocation(new UAL(ual)); }
	public Idle(boolean o, UAN __uan)	{ super(false,__uan); }
	public Idle(boolean o, UAL __ual)	{ super(false,__ual); }
	public Idle(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Idle(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Idle(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Idle()		{  }
	public Idle(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.idle.Idle", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Idle)actorReference).setUAL(getUAL());
			((Idle)actorReference).setUAN(getUAN());
			self = new Idle(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.idle.Idle$State" );
		...
		public void act(String[] args) {
			try {
				...
				{
					// standardOutput<-println("Usage: java examples.idle.Idle <#time>")
					{
						Object _arguments[] = { "Usage: java examples.idle.Idle <#time>" };
						Message message = new Message( self, standardOutput, "println", _arguments, null, null );
						__messages.add( message );
					}
				}
