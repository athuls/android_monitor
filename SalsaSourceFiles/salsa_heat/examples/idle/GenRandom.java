...
public class GenRandom extends UniversalActor  {
	public static void main(String args[]) {
		...
		GenRandom instance = (GenRandom)new GenRandom(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new GenRandom(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return GenRandom.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new GenRandom(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return GenRandom.getReferenceByLocation(new UAL(ual)); }
	public GenRandom(boolean o, UAN __uan)	{ super(false,__uan); }
	public GenRandom(boolean o, UAL __ual)	{ super(false,__ual); }
	public GenRandom(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public GenRandom(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public GenRandom(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public GenRandom()		{  }
	public GenRandom(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.idle.GenRandom", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public GenRandom self;
		public void updateSelf(ActorReference actorReference) {
			((GenRandom)actorReference).setUAL(getUAL());
			((GenRandom)actorReference).setUAN(getUAN());
			self = new GenRandom(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.idle.GenRandom$State" );
		...
		public long CalcRand(long value) {
			Random randomno = new Random();
			int val1 = randomno.nextInt(10);
			return value*val1;
		}
			...
			for (int i = 0; i<100000; i++){
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, self, "GRandom", _arguments, null, token_3_0 );
