...
public class Display extends UniversalActor  {
	public static void main(String args[]) {
		...
		Display instance = (Display)new Display(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Display(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Display.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Display(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Display.getReferenceByLocation(new UAL(ual)); }
	public Display(boolean o, UAN __uan)	{ super(false,__uan); }
	public Display(boolean o, UAL __ual)	{ super(false,__ual); }
	public Display(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Display(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Display(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Display()		{  }
	public Display(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.display.Display", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Display)actorReference).setUAL(getUAL());
			((Display)actorReference).setUAN(getUAN());
			self = new Display(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.display.Display$State" );
			...
			try {
				{
					...
					// PrintBright(token, Integer.parseInt(args[0]), Integer.parseInt(args[1]))
					{
						Object _arguments[] = { token_3_2, Integer.parseInt(args[0]), Integer.parseInt(args[1]) };
				...
				{
					// standardOutput<-println("Usage: java examples.display.Display <#time>")
					{
						Object _arguments[] = { "Usage: java examples.display.Display <#time>" };
						Message message = new Message( self, standardOutput, "println", _arguments, null, null );
						__messages.add( message );
					}
				}
