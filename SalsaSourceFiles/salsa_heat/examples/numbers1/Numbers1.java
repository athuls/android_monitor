...
public class Numbers1 extends UniversalActor  {
	public static void main(String args[]) {
		...
		Numbers1 instance = (Numbers1)new Numbers1(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Numbers1(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Numbers1.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Numbers1(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Numbers1.getReferenceByLocation(new UAL(ual)); }
	public Numbers1(boolean o, UAN __uan)	{ super(false,__uan); }
	public Numbers1(boolean o, UAL __ual)	{ super(false,__ual); }
	public Numbers1(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Numbers1(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Numbers1(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Numbers1()		{  }
	public Numbers1(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers1.Numbers1", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Numbers1 self;
		public void updateSelf(ActorReference actorReference) {
			((Numbers1)actorReference).setUAL(getUAL());
			((Numbers1)actorReference).setUAN(getUAN());
			self = new Numbers1(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers1.Numbers1$State" );
		...
		public void act(String args[]) {
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "Dummy1", _arguments, null, null );
					__messages.add( message );
				}
			}
			{
