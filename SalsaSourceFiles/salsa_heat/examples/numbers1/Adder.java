...
public class Adder extends UniversalActor  {
	...
	public Adder(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers1.Adder", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers1.Adder$State" );
		...
		public void go() {
			for (int i = 0; i<1000; i++){
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, number, "inc", _arguments, null, currentMessage.getContinuationToken() );
			...
			}
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, number, "inc", _arguments, null, token_2_0 );
					__messages.add( message );
				}
