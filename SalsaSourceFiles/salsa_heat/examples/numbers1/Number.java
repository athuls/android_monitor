...
public class Number extends UniversalActor  {
	...
	public Number(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers1.Number", sourceRef);
			  }
	...
	public UniversalActor construct (long number) {
		Object[] __arguments = { new Long(number) };
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers1.Number$State" );
