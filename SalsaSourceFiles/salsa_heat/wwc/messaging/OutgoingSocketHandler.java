...
//System.out.println("retry="+retry);
		...
		try {
  		...
  		//System.out.println( "[Custom] ### OutgoingSocketHandler, put() called " + o);
                objects.addElement(o);
                notify();
		} catch (Exception e) {
			// System.err.println("[Custom] Failed with exception " + e.toString());
			throw e;
		}
        }
	    ...
	    if (o instanceof Message) {
        	// System.out.println("[Custom]    send msg in Output handler send:"+ ((Message)o).getMethodName());
	    }
...
//System.out.println("    send sys:"+ ((gc.SystemMessage)o).getMethodName());
	    ...
	    // System.err.println("[Custom] \t Something is wrong with socket Exception: " + e);        	  
